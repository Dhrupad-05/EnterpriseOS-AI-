...
class CrisisAgent(Agent[BusinessEventInput, CrisisRecommendation]):
    ...
    def __init__(self, product_repository=None, incident_repository=None, vendor_agent=None):
        self.product_repository=product_repository or InMemoryProductRepository(); self.incident_repository=incident_repository or InMemoryIncidentRepository(); self.dependencies=[vendor_agent or VendorIntelligenceAgent()]
